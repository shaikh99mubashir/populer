                ...
                <div className='cont' >
                  ...
                  >
                    <List className="catdraw">
                      <h1 style={{ padding: '10px 20px', fontFamily: "Gill Sans" }}>CATEGORIES</h1>
                                  ...
                                  {data.quantity ?
                                    <>
                                      <Link to={`/ProductDetail/${data.name}`} style={{ textDecoration: 'inherit', color: 'inherit' }}>
                                        ...
                                        />
                                        {data.discountPrice ?
                                          <div style={{ backgroundColor: '#fb550e', float: 'right', width: '35%', color: 'white', fontFamily: "Gill Sans" }}>
...
{data.spec}
                    ...
                    <span className="disperf">-{data.discountPercenage}%</span>
                                    ...
                                    <>
                                      {data.discountPrice ?
                                        <div style={{ backgroundColor: '#fb550e', float: 'right', width: '35%', textAlign: 'center', color: 'white', fontFamily: "Gill Sans" }}>
                                          {/* <h6 style={{ fontWeight: "bold", fontSize: "12px", color: 'white', textAlign: 'center' }}>Sale</h6> */}
                                          {data.quantity == 0 ? 'SOLD' : 'SALE'}
                                        </div>
                                        :
